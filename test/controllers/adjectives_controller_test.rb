...
class AdjectivesControllerTest < ActionController::TestCase
  ...
  test "should create adjective" do
    assert_difference('Adjective.count') do
      post :create, adjective: { lemma: @adjective.lemma, lexdom: @adjective.lexdom, lexdomname: @adjective.lexdomname, pos: @adjective.pos }
    end
  ...
  test "should update adjective" do
    patch :update, id: @adjective, adjective: { lemma: @adjective.lemma, lexdom: @adjective.lexdom, lexdomname: @adjective.lexdomname, pos: @adjective.pos }
    assert_redirected_to adjective_path(assigns(:adjective))
  end
